...
public class PolicyCompat {
    private static final String PHONE_WINDOW_CLASS_NAME = "com.android.internal.policy.impl.PhoneWindow";
    //6.0的包路径
    private static final String M_PHONE_WINDOW_CLASS_NAME = "com.android.internal.policy.PhoneWindow";
    ...
    private static Window createPhoneWindow(Context context) {
        try {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                cls = Class.forName(M_PHONE_WINDOW_CLASS_NAME);
            } else {
                cls = Class.forName(PHONE_WINDOW_CLASS_NAME);
            }
            /* Get constructor */
